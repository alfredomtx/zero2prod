...
async fn newsletters_returns_400_for_invalid_data() {
    ...
    let test_cases = vec![(
        serde_json::json!({
            "content": {
                "text": "Newsletetr body as plain text",
...
async fn create_unconfirmed_subscriber(app: &TestApp) -> ConfirmationLinks {
    ...
    // We now inspect the requests received by the mock Postmark email_server
    // to retrieve the confirmaton link and return it
