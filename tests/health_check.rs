...
async fn spawn_app() -> TestApp {
    ...
    // Generate a new random database name for each test
...
//     println!("Dropping database {}", &app.db_name);
//     sqlx::query(&format!(r#"DROP DATABASE "{}";"#, &app.db_name))
//     .execute(&app.db_pool)
//     .await
...
async fn subscribe_returns_a_200_when_fields_are_present_but_empty(){
    ...
    let test_cases = vec![
        ...
        ("name=Alfredo&email=definitely-not-an-email", "invalid email"),
    ];
